...
public class PLSQLParserParser extends Parser {
	...
	public static final int
		RULE_script = 0, RULE_statement = 1, RULE_insert_stmt = 2, RULE_value_list = 3, 
		RULE_expr = 4;
	private static String[] makeRuleNames() {
		return new String[] {
			"script", "statement", "insert_stmt", "value_list", "expr"
		};
	}
	...
	public static class Insert_stmtContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(PLSQLParserParser.ID, 0); }
	...
	public final Insert_stmtContext insert_stmt() throws RecognitionException {
		...
		enterRule(_localctx, 4, RULE_insert_stmt);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(20);
	...
	public final Value_listContext value_list() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_value_list);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
